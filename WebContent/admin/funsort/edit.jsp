...
<body>
	<div class="fix_box">
		...
		<div class="main_content_fix">
			<form action="${pageContext.request.contextPath }/adminEditFunsort" method="post">
				<input type="hidden" name="fun_id" value="${funSort.fun_id }">
				<table>
					<tr>
						<th>商品名称：</th>
						<td><input type="text" name="fun_name" value="${funSort.fun_name }"></td>
					</tr>
				</table>
				<div class="btn_box">
		...
		function Btn(classname) {
			...
			$(btn)
					.click(
							function(e) {
								e.preventDefault();
								parent.document.getElementById("rightFrame").src = '${pageContext.request.contextPath }/admin/funsort/list.jsp';
							})
		}
	</script>
</body>
